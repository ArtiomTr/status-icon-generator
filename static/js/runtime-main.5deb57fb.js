!(function (t) {
    function e(e) {
        for (var n, a, i = e[0], l = e[1], c = e[2], p = 0, s = []; p < i.length; p++)
    ...
    function r() {
        for (var t, e = 0; e < u.length; e++) {
            for (var r = u[e], n = !0, i = 1; i < r.length; i++) {
                var l = r[i];
                0 !== o[l] && (n = !1);
            }
            n && (u.splice(e--, 1), (t = a((a.s = r[0]))));
        }
        return t;
    }
    var n = {},
    ...
    (a.m = t),
        ...
        (a.p = 'https://fracht.github.io/status-icon-generator/');
    var i = (this['webpackJsonpstatus-icon-generator'] = this['webpackJsonpstatus-icon-generator'] || []),
        l = i.push.bind(i);
    (i.push = e), (i = i.slice());
...
//# sourceMappingURL=runtime-main.5deb57fb.js.map
